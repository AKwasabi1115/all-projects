...
/*	string userAnswer;
	...
	*/
	...
	double negative remainder = itemPrice - money;
	...
	if (userInput == "No" || userInput == "no")
	{
		...
		if (money >= itemPrice)
		{
			cout << "You have enough money to purchase a " << item << ", with a remainder of $" << remainder;
		}
		else if (money <= itemPrice)
		{
			cout << "Sorry, you do not have enough to purchase a " << item << endl;
			cout << "You have: $" << money << "and need " << negativeRemainder << "more. " << endl;
		}
	}
